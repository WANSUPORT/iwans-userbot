...
CMD_HELP.update(
    {
        ...
        \n\n  »  **Perintah :** `{cmd}sleep`\
        \n  »  **Kegunaan : **Biarkan iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝 tidur selama beberapa detik \
    "
    }
)
...
CMD_HELP.update(
    {
        "repo": f"**Plugin : **`Repository iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝`\
        \n\n  »  **Perintah :** `{cmd}repo`\
        \n  »  **Kegunaan : **Menampilan link Repository iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝\
        \n\n  »  **Perintah :** `{cmd}string`\
        \n  »  **Kegunaan : **Menampilan link String iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝\
    "
    }
)
...
CMD_HELP.update(
    {
        "restart": f"**Plugin : **`Restart iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝`\
