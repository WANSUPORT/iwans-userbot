...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/sip-userbot/Wans/Wanssupport/DEVS.json"
    )
...
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL", "https://github.com/WANSUPORT/iwans.git")
