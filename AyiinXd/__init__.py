...
while 0 < 6:
    _DEVS = get(
        "https://raw.githubusercontent.com/WANSUPPORT/Wans/Wanssupport/DEVS.json"
    )
...
UPSTREAM_REPO_URL = os.environ.get("UPSTREAM_REPO_URL",https://github.com/WANSUPORT/iwans-userbot.git")
...
ALIVE_TEKS_CUSTOM = os.environ.get(
    "ALIVE_TEKS_CUSTOM",
    "𝙷𝙴𝚈, 𝚂𝙰𝚈𝙰 𝙿𝙴𝙽𝙶𝙶𝚄𝙽𝙰 iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝 ")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝")
...
async def update_restart_msg(chat_id, msg_id):
    message = (
        f"**Iwan - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝 v`{BOT_VER}` is back up and running!**\n\n"
        f"**Telethon:** `{vsc}`\n"
    ...
    try:
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:
                ...
                text = f"**✨ iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝 𝙸𝙽𝙻𝙸𝙽𝙴 𝙼𝙴𝙽𝚄 ✨**\n\n⍟ **ʙᴀsᴇ ᴏɴ :** {adB.name}\n⍟ **ᴅᴇᴘʟᴏʏ :** •[{HOSTED_ON}]•\n⍟ **ᴏᴡɴᴇʀ** {user.first_name}\n⍟ **ᴊᴜᴍʟᴀʜ :** {len(dugmeler)} **Modules**"
                await event.edit(
                    text,
                    file=logoyins,
                    buttons=buttons,
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith(
                ...
                result = builder.article(
                    title="String",
                    description="String iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝",
                    ...
                    buttons=[
                        [
                            custom.Button.url(
                                "Bᴏᴛ Sᴛʀɪɴɢ",
                                url="https://t.me/wansstringbot?start="),
                            custom.Button.url(
                                "Sᴛʀɪɴɢ Rᴇᴘʟɪᴛ",
                ...
                result = builder.article(
                    title="Lang",
                    description="Lang iwans - 𝚄𝚜𝚎𝚛𝚋𝚘𝚝",
                    url="https://t.me/wansnonsupport",
                    thumb=InputWebDocument(
                        logoyins,
                        0,
